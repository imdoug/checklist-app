      ...
      <>
            <header className='homeHeader'>
                  ...
                  <div style={{display : 'flex',alignItems: 'center'}}>
                        <div style={{height: '40px', width: '40px', background: 'blue', borderRadius: '50%', marginRight: '16px'}}></div>
                        <p style={{fontSize: '32px', fontWeight: '700', color: '#242424'}}>Lists</p>
                  </div>
                  {/* create new list icon */}
                  <div onClick={goToAdd}>
                        <svg className='create' width="23.75" height="23.75" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <CreateItem goToAdd={goToAdd}/>
            {checklist.length === 0 ? <></>: <CustomItem checklist={checklist} deleteItem={deleteItem} editItem={editItem}/>}
      </>
  )
}
