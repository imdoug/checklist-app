      ...
      <>
            <div style={{alignSelf: 'center', paddingRight: 16}} >
                                    ...
                                    <Menu 
                                          ...
                                          onClose={handleClose}
                                    >
                                          <MenuItem  style={{width: 115, height: 22, padding: '16px', fontSize: 22,fontWeight: 700}} onClick={() => {goToEdit(item)}} >
                                                <svg style={{marginRight: 4}} width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                                          ...
                                          <MenuItem id="menu-item" style={{width: 110, height: 22, padding: '16px', fontSize: 22, fontWeight: 700}} onClick={() =>{delItem(index)}}>
                                                <svg style={{marginRight: 4}} width="110" height="40px" viewBox="0 0 16 18"  xmlns="http://www.w3.org/2000/svg">
                                                      <g clipPath="url(#clip0_730_522)">
