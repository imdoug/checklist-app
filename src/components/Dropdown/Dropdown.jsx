  ...
  return (
      <>
            <div>
                                    ...
                                    onClick={handleClick}
                                    >
                                          <svg className='options'  width="18" height="4" viewBox="0 0 18 4" fill="#28292E" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    >
                                          <MenuItem onClick={() => {goToEdit(item)}}>
                                          ...
                                          <MenuItem onClick={() =>{delItem(index)}}>
